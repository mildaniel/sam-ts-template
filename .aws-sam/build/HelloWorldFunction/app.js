...
var require_enhanceError = __commonJS({
  "node_modules/axios/lib/core/enhanceError.js"(exports, module2) {
    "use strict";
    module2.exports = function enhanceError(error, config, code, request, response2) {
      error.config = config;
      if (code) {
        error.code = code;
      }
...
var require_createError = __commonJS({
  "node_modules/axios/lib/core/createError.js"(exports, module2) {
    ...
    module2.exports = function createError(message, config, code, request, response2) {
      var error = new Error(message);
      return enhanceError(error, config, code, request, response2);
    };
  }
});
  ...
  "node_modules/follow-redirects/index.js"(exports, module2) {
    ...
    function RedirectableRequest(options, responseCallback) {
      ...
      this._onNativeResponse = function(response2) {
        self._processResponse(response2);
      };
    ...
    RedirectableRequest.prototype._processResponse = function(response2) {
      ...
      if (location && this._options.followRedirects !== false && statusCode >= 300 && statusCode < 400) {
        ...
        if (typeof this._options.beforeRedirect === "function") {
          var responseDetails = { headers: response2.headers };
          try {
